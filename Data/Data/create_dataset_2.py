...
annot_file = '../../falldata/falldown.csv'  # from create_dataset_1.py
video_folder = '../../falldata/Videos'
annot_folder = '../../falldata/Annotation_files'  # bounding box annotation for each frame.
